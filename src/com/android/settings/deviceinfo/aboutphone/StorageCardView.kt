...
class StorageCardView(context: Context, attrs: AttributeSet?) : AboutBaseCard(context, attrs) {
    ...
    init {
        ...
        storageTitle.setTextColor(
            Utils.getColorAttrDefaultColor(context, android.R.attr.textColorPrimary)
        )
        storageTitle.layoutParams =
            RelativeLayout.LayoutParams(
    ...
    private inner class WaveView(context: Context?) : LinearLayout(context) {
        ...
        fun setLowStorage(lowStorage: Boolean) {
            mAboveWaveColor =
                if (lowStorage) Utils.getColorAttrDefaultColor(context, android.R.attr.colorError)
    ...
    @JvmOverloads
    constructor(context: Context?, attrs: AttributeSet?, defStyle: Int = R.attr.waveViewStyle) :
        ...
        fun initializeWaveSize(waveMultiple: Int, waveHeight: Int, waveHz: Int) {
            ...
            val params =
                ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mWaveHeight * 2)
            layoutParams = params
        }
